          ...
          >
            ...
            <div className="w-max flex flex-col gap-[0.5rem] cursor-pointer group/btn">
              <div className="flex items-center">
                <p className="text-underline font-bold text-[1.5rem] leading-[120%] font-sans text-white transition-colors duration-500 group-hover/btn:text-accent">
                  Apply to study
                </p>
              ...
              <hr className="w-[9.625rem] h-[0.125rem] bg-white border-0 transition-all duration-500 group-hover/btn:w-full group-hover/btn:bg-accent hover:bg-accent" />
            </div>
          </div>
        </div>
      </section>
